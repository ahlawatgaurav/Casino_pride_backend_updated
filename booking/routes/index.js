...
router.get("/displayPackagesEnabled", bookingController.displayPackagesEnabled);
router.get("/displayPackagesForCategory", bookingController.displayPackagesForCategory);
...
router.post("/sendSMS", bookingController.sendSMS);
router.put("/updateCommission", bookingController.updateCommission);
